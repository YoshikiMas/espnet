...
pip install -U openai-whisper --no-cache
...
gen_dir=exp/speechlm_se_chime4_train_valle2/decode_se_latest/se_et05_simu_isolated_1ch_track
ref_dir=data/et05_simu_isolated_1ch_track  # Too small speaker variety
key_file=UNK
eval_wer=true
eval_spk=true
eval_mos=true
